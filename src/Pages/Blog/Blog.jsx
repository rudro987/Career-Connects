...
const Blog = () => {
    return (
        ...
        <h2 className="text-2xl font-semibold underline text-center">Access Token and Refresh Token</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold underline text-center">What is Express JS?</h2>
        <p>
        Express is a node js web application framework that provides broad features for building web and mobile applications. It is used to build a single page, multipage, and hybrid web application.
        <br /><br />It's a layer built on the top of the Node js that helps manage servers and routes.
        </p>
        <h2 className="text-2xl font-semibold underline text-center">What is Nest JS?</h2>
        <p>
        Nest (NestJS) is a framework for building efficient, scalable Node.js server-side applications. It uses progressive JavaScript, is built with and fully supports TypeScript (yet still enables developers to code in pure JavaScript) and combines elements of OOP (Object Oriented Programming), FP (Functional Programming), and FRP (Functional Reactive Programming).
        <br /><br />Under the hood, Nest makes use of robust HTTP Server frameworks like Express (the default) and optionally can be configured to use Fastify as well!
        <br /><br />Nest provides a level of abstraction above these common Node.js frameworks (Express/Fastify), but also exposes their APIs directly to the developer. This gives developers the freedom to use the myriad of third-party modules which are available for the underlying platform.
