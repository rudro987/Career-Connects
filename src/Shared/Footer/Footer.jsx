      ...
      <div className="max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
          ...
          <div className="col-span-1">
            <h4 className="font-semibold text-charcoalGray">Product</h4>

            <div className="mt-3 grid space-y-3">
              <p>
                <a
                  className="inline-flex gap-x-2 text-gray-500 hover:text-gray-400"
                  href="#"
                >
                  Pricing
                </a>
          ...
          <div className="col-span-1">
            <h4 className="font-semibold text-charcoalGray">Company</h4>
            ...
            <div className="mt-3 grid space-y-3">
              ...
              <p>
                ...
                <span className="inline ml-1 text-xs bg-skyBlue text-white py-1 px-2 rounded-md">
                  We're hiring
                </span>
              </p>
              <p>
          ...
          <div className="col-span-2">
            <h4 className="font-semibold text-charcoalGray">Stay up to date</h4>
            ...
            <form>
              <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-md p-2">
                ...
                <a
                  className="w-full sm:w-auto whitespace-nowrap inline-flex justify-center items-center gap-x-3 text-center bg-skyBlue  border border-transparent text-white font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition py-3 px-4"
                  href="#"
                >
                  Subscribe
                </a>
